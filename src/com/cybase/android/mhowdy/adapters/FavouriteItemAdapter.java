...
public class FavouriteItemAdapter extends BaseAdapter {
	...
	private ArrayList<HashMap<String, String>> favouritesList;
	...
	public FavouriteItemAdapter(Context context,
		...
		this.favouritesList = placesList;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		View view;
		view = inflater.inflate(R.layout.listitem_favouriteitem, null);
		...
		HashMap<String, String> place = favouritesList.get(position);
